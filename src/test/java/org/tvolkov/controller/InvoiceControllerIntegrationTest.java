...
public class InvoiceControllerIntegrationTest {
    ...
    public void getInvoicesByCustomerIdAndMonth(){
        ResponseEntity<List<Invoice>> responseEntity = restTemplate.exchange(API_PATH + "?customerId=21&month=2017-01",
        ...
        assertEquals(YearMonth.parse("2017-01"), invoice.getMonth());
        assertEquals(11, invoice.getAddress().getId());
    }

    @Test
    public void getInvoicesByCustomerIdFilterAndMonth(){
        ResponseEntity<List<Invoice>> responseEntity = restTemplate.exchange(API_PATH + "?customerId=21&filter=shopPurchase&month=2017-03",
                HttpMethod.GET, null, new ParameterizedTypeReference<List<Invoice>>(){});
        ...
        assertEquals(YearMonth.parse("2017-03"), invoice.getMonth());
    ...
    public void getInvoicesByCustomerIdAndAddress(){
        ...
        assertEquals(InvoiceType.advancePayment, invoice.getInvoiceType());
        assertEquals(99.9, invoice.getAmount(), 0);
        assertEquals(YearMonth.parse("2017-06"), invoice.getMonth());
    ...
    public void generateInvoice() throws URISyntaxException {
        ...
        RequestEntity<String> requestEntity = new RequestEntity<>("{\"invoiceType\" : \"shopPurchase\",\"amount\" : 79.9,\"address\" : 15,\"month\" : \"2017-06\"}", headers, HttpMethod.POST, new URI(API_PATH));
